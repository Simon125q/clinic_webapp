...
import com.project.backend.security.jwt.JwtAuthTokenFilter;
import com.project.backend.security.services.UserDetailsServiceImplementation;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        System.out.println("role: " + http.toString());
